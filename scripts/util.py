import select, time, electrum_ulm as electrum, Queue
from electrum_ulm import Connection, Interface, SimpleConfig
from electrum_ulm.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'electrum-ulm.bysh.me:50002:s'
