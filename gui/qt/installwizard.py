...
from electrum_ulm import Wallet, WalletStorage
from electrum_ulm.util import UserCancelled, InvalidPassword
from electrum_ulm.base_wizard import BaseWizard
...
MSG_ENTER_ANYTHING = _("Please enter a seed phrase, a master key, a list of "
                       "Unlimitedcoin addresses, or a list of private keys")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electrum-ULM  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/electrum-ulm.png')
        self.show()
        self.raise_()
