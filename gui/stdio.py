...
from electrum_ulm.util import format_satoshis, set_verbosity
from electrum_ulm.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_ulm.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-ulm create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Unlimitedcoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-ulm setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-ulm setconfig' to change your settings")
        return True
