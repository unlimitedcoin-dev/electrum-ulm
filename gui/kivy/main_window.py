...
import electrum_ulm as electrum
from electrum_ulm.bitcoin import TYPE_ADDRESS
from electrum_ulm import WalletStorage, Wallet
from electrum_ulm_gui.kivy.i18n import _
from electrum_ulm.paymentrequest import InvoiceStore
from electrum_ulm.util import profiler, InvalidPassword
from electrum_ulm.plugins import run_hook
from electrum_ulm.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='electrum_ulm_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_ulm_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_ulm_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_ulm_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_ulm_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_ulm_gui.kivy.uix.screens')
...
from electrum_ulm.util import base_units
...
class ElectrumWindow(App):
    ...
    def on_new_intent(self, intent):
        if intent.getScheme() != 'unlimitedcoin':
            return
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'ULM')
    ...
    def on_qr(self, data):
        from electrum_ulm.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_ulm.transaction import Transaction
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_ulm.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_ulm_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_ulm_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_ulm_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_ulm_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-ulm.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-ULM', message,
                            app_icon=icon, app_name='Electrum-ULM')
        except ImportError:
