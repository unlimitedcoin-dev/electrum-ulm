...
from electrum_ulm.keystore import bip39_normalize_passphrase
from electrum_ulm.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the unlimitedcoins in the wallet.") % self.device
        else:
...
class TrezorClientBase(GuiMixin, PrintError):
    ...
    #    return self.get_address('Unlimitedcoin', self.expand_path(derivation))
